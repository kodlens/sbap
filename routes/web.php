...
Route::get('/load-priority-programs', [App\Http\Controllers\OpenController::class, 'loadPriorityPrograms']);
...
Route::middleware(['auth'])->group(function() {
   ...
   Route::get('/load-report-by-allotment-classes', [App\Http\Controllers\Administrator\DashboardController::class, 'loadReportByAllotmentClasses']);
    ...
    Route::get('/load-report-dashboard', [App\Http\Controllers\Administrator\DashboardController::class, 'loadReportDashboard']);
...
Route::middleware(['auth'])->group(function() {
    ...
    Route::resource('/augmentation-budgets', App\Http\Controllers\AugmentationBudgetController::class);
    Route::get('/get-augmentation-budgets', [App\Http\Controllers\AugmentationBudgetController::class, 'getData']);
